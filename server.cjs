...
process.env.NEXUS_NAME = process.env.NEXUS_NAME || "Donor Coordination Hub";
process.env.ENTITY_LABEL = process.env.ENTITY_LABEL || "Donor Record";
process.env.TABLE_NAME = process.env.TABLE_NAME || "donor_record_records";
'use strict';
